...
export const AIHealthChat = ({ userProfile, vitalSigns }: HealthChatProps) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'ai',
      content: "Hello! I'm your Health Assistant. I can help you understand your health data, provide personalized recommendations, and answer questions about your Digital Twin. How can I help you today?",
      timestamp: new Date()
    }
  ]);
